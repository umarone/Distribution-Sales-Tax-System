...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        frmStockReceiptReturn frmStockReceiptReturn = null;
        ...
        frmProductFocLedger frmproductfocledger = null;
        ...
        frmFBRSheets frmtaxsheets = null;

        #region Area Setup
        frmRegions frmareaRegions;
        #endregion
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (SoftwareType() == "Distribution Trading")
            {
                ...
                rbnBtnPartyWiseSaleSummary.Visible = true;
        ...
        {
            List<ModulesEL> elClosingBalancesModule = list.FindAll(x => x.ModuleName == "Closing Balances" || x.ModuleName == "Aging Report");
        ...
        private void rbnBtnRegions_Click(object sender, EventArgs e)
        {
            frmareaRegions = new frmRegions();
            frmareaRegions.MdiParent = this;
            if (Operations.IdRole == Validation.GetSafeLong(EnRoles.CheifExecutive) || Operations.IdRole == Validation.GetSafeLong(EnRoles.Administrator))
            {
                frmareaRegions.Show();
            }
            else if (CheckModuleRights(frmareaRegions.Name) != 0)
            {
                frmareaRegions.Show();
            }
            else
            {
                frmareaRegions.Dispose();
                MessageBox.Show("Access Is Denied");
            }
            RibbonAutoclose();
        }
        ...
        {
            frmStockReceiptReturn = new frmStockReceiptReturn();
            frmStockReceiptReturn.MdiParent = this;
            frmStockReceiptReturn.IsNetTransaction = false;
            if (Operations.IdRole == Validation.GetSafeLong(EnRoles.CheifExecutive) || Operations.IdRole == Validation.GetSafeLong(EnRoles.Administrator))
            {
                frmStockReceiptReturn.Show();
            }
            else if (CheckModuleRights(frmStockReceiptReturn.Name) != 0)
            {
                frmStockReceiptReturn.Show();
            }
            else
        ...
        private void rbnBtnCashPurchaseReturn_Click(object sender, EventArgs e)
        {
            frmStockReceiptReturn = new frmStockReceiptReturn();
            frmStockReceiptReturn.MdiParent = this;
            frmStockReceiptReturn.IsNetTransaction = true;
            if (Operations.IdRole == Validation.GetSafeLong(EnRoles.CheifExecutive) || Operations.IdRole == Validation.GetSafeLong(EnRoles.Administrator))
            {
                frmStockReceiptReturn.Show();
            }
        ...
        private void rbnBtnProductsFocLedger_Click(object sender, EventArgs e)
        {
            frmproductfocledger = new frmProductFocLedger();
            frmproductfocledger.MdiParent = this;
            frmproductfocledger.Show();
            RibbonAutoclose();
        }
        ...
        private void rbnBtnFbrSheets_Click(object sender, EventArgs e)
        {
            frmtaxsheets = new frmFBRSheets();
            frmtaxsheets.MdiParent = this;
            frmtaxsheets.Show();
        }
        #endregion

...
namespace Accounts.UI
{
    public partial class frmPersons : MetroForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            oelPerson.SaleTaxNo = Validation.GetSafeString(txtSaleTaxNo.Text);
        ...
        private void ClearControls()
        {
            ...
            txtSaleTaxNo.Text = string.Empty;
        ...
        private void GetPerson(string AccountNo)
        {
            ...
            if (list.Count > 0)
            {
                ...
                txtSaleTaxNo.Text = list[0].SaleTaxNo;
                ...
                if (list[0].IdCity > 0)
                {
                    ...
                    LoadRegionsByCity(list[0].IdCity);

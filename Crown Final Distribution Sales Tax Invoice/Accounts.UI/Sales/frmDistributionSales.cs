...
namespace Accounts.UI
{
    public partial class frmDistributionSales : MetroForm
    {
        ...
        string CustomerAccountNo = "", SalesAccountNo = "", CashAccountNo = "", EmpAccountNo = "0", EmpDeliveryAccountNo = "0", SalesTaxAccountNo = "";
            ...
            if (list.Count > 0)
            {
                ...
                if (objActiveType != null)
                {
                    if (objActiveType.SoftwareType == "General Trading")
                    {
                        ...
                        DgvStockSales.Columns["colNormalDiscountPercentage"].Width = 80;
                        DgvStockSales.Columns["colNormalDiscountFlat"].Width = 90;
                    ...
                    else if (objActiveType.SoftwareType == "Distribution Trading")
                    {
                        ...
                        DgvStockSales.Columns["colpacking"].Width = 70;
                        DgvStockSales.Columns["colCurrentStock"].Width = 60;
                        DgvStockSales.Columns["colQty"].Width = 55;
                        DgvStockSales.Columns["colBonusUnit"].Width = 50;
                        DgvStockSales.Columns["colUnitPrice"].Width = 50;
                        DgvStockSales.Columns["colAmount"].Width = 70;
                        DgvStockSales.Columns["colNormalDiscountPercentage"].Width = 60;
                        DgvStockSales.Columns["colNormalDiscountFlat"].Width = 80;
                        DgvStockSales.Columns["colBulkDiscountPercentage"].Width = 75;
                        DgvStockSales.Columns["colNetAmount"].Width = 85;
                        DgvStockSales.Columns["colDelete"].Width = 50;
                    }
                }
            }
        }
        ...
        private void FillCustomer(string AccountNo)
        {
            ...
            if (list.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(list[0].PersonName))
                {
                    SEditBox.Text = list[0].PersonName + " -" + list[0].Address;
                }
                if (list[0].SaleTaxNo != string.Empty)
                {
        ...
        private bool ValidateRows()
        {
            ...
            {
                if (DgvStockSales.Rows[i].Cells["colUnitPrice"].Value == null)
                {
                    return false;
                }
            }
                ...
                if (ValidateControls())
                {
                    if (ValidateBookPeriod())
                    {
                        ...
                        for (int i = 0; i < DgvStockSales.Rows.Count - 1; i++)
                        {
                            ...
                            string[] Diemension = Validation.GetSafeString(DgvStockSales.Rows[i].Cells["colDims"].Value).Split('*');
                            ...
                            oelSaleDetial.Boxes = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBoxes"].Value);
                            oelSaleDetial.Pieces = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colPieces"].Value);
                            if (Diemension[1] == "0")
                            {
                                oelSaleDetial.Qty = (Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colQty"].Value) * Validation.GetSafeDecimal(Diemension[2])) + Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colPieces"].Value);
                            }
                            else
                            {
                                oelSaleDetial.Qty = (Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colQty"].Value) * Validation.GetSafeDecimal(Diemension[1]) * Validation.GetSafeDecimal(Diemension[2])) + Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(Diemension[2]) + (Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colPieces"].Value));
                            }
                            ...
                            oelSaleDetial.Discount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountPercentage"].Value.ToString().Replace('%', ' '));
                            oelSaleDetial.DiscountAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountFlat"].Value);
                            oelSaleDetial.BulkDiscountPercentage = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' '));
                            oelSaleDetial.BulkDiscountFlatAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBulkDiscountFlat"].Value);
                            oelSaleDetial.FlatDiscount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBulkDiscount"].Value);
                            oelSaleDetial.AmountIncludingDiscounts = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountFlat"].Value);
                            oelSaleDetial.SaleTaxPercentage = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colSalesTaxPercentage"].Value.ToString().Replace('%', ' '));
                            oelSaleDetial.SaleTaxFlatAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colSaleTaxFlat"].Value);
                            oelSaleDetial.OtherTaxPercentage = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colExtraTaxPercentage"].Value.ToString().Replace('%', ' '));
                            oelSaleDetial.OtherTaxFlatAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colExtraTaxFlat"].Value);

                            //oelSaleDetial.Discount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountPercentage"].Value.ToString().Replace('%', ' '));
                            //oelSaleDetial.DiscountAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountFlat"].Value);
                            //oelSaleDetial.PromoDiscount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' '));
                            oelSaleDetial.NetAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNetAmount"].Value);
                        ...
                        if (chkPosted.Checked)
                        {
                            decimal PiecesQuantity = 0;
                            for (int k = 0; k < DgvStockSales.Rows.Count - 1; k++)
                            {
                                var IManager = new ItemsBLL();
                                string[] Diemension = Validation.GetSafeString(DgvStockSales.Rows[k].Cells["colDims"].Value).Split('*');
                                if (Diemension[1] == "0")
                                {
                                    PiecesQuantity += (Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colQty"].Value) * Validation.GetSafeDecimal(Diemension[2])) + Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colPieces"].Value);
                                }
                                else
                                {
                                    PiecesQuantity += (Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colQty"].Value) * Validation.GetSafeDecimal(Diemension[1]) * Validation.GetSafeDecimal(Diemension[2])) + Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(Diemension[2]) + (Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colPieces"].Value));
                                }
                                ...
                                oelProductsProfitLoss.NetSaleAmount = Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colNetAmount"].Value);
                                oelProductsProfitLoss.SaleCost = Validation.GetSafeDecimal(IManager.GetItemsAvgValueWOT(oelProductsProfitLoss.IdItem.Value)) * PiecesQuantity;
                                oelProductsProfitLoss.Units = Validation.GetSafeDecimal(PiecesQuantity);
                        ...
                        if (chkPosted.Checked)
                        {
                            ...
                            for (int k = 0; k < DgvStockSales.Rows.Count - 1; k++)
                            {
                                ...
                                //if (Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colNormalDiscountFlat"].Value) > 0)
                                //{
                                    ...
                                    if (oelCostOfSalesCollection.Count > 0)
                                    {
                                        ...
                                        if (oelFindInventoryDetail != null)
                                        {
                                            oelFindInventoryDetail.Credit += Validation.GetSafeDecimal(IManager.GetItemsAvgValueWOT(EachItem[0].IdItem.Value)) *
                                                                             PiecesQuantity; //EachItem[0].AVGEvaluationUnitPrice;
                                            //oelCostOfSalesCollection.Add(oelFindInventoryDetail);
                                        }
                                        else
                                        {
                                            oelCostOfSalesCollection.Add(CreateInventoryTransaction(oelVoucher, EachItem, PiecesQuantity));
                                        }
                                    }
                                    else
                                    {
                                    ...
                                    if (oelCostOfSalesCollection.Count > 0)
                                    {
                                        ...
                                        {
                                            oelCostOfSalesCollection.Add(CreateCOGSTransaction(oelVoucher, EachItem, PiecesQuantity));
                                        }
                                    }
                                    else
                                    {
                        ...
                        if (RdCreditSales.Checked)
                        {
                            ...
                            else
                            {
                                if (txtDescription.Text != string.Empty)
                                    ...
                                    oelCustomerTransaction.Description = SEditBox.Text + " Is Credited Against Credit Sales @" + txtTotalAmount.Text;
                            }
                        ...
                        if (txtDescription.Text != string.Empty)
                        {
                            ...
                            oelSaleTransaction.Description = "Sales Account Is Credited @" + txtAmountafterDiscount.Text;
                        oelSaleTransaction.Debit = 0;
                        oelSaleTransaction.Credit = Math.Round(Validation.GetSafeDecimal(txtAmountafterDiscount.Text));
                        ...
                        /// Add Tax Account...
                        VoucherDetailEL oelSaleTaxTransaction = new TransactionsEL();
                        if (SalesTaxTransactionId.HasValue && SalesTaxTransactionId.Value > 0)
                        {
                            oelSaleTaxTransaction.IdTransactionDetail = SalesTaxTransactionId.Value;
                            oelSaleTaxTransaction.IsNew = false;
                        }
                        else
                        {
                        ...
                        oelSaleTaxTransaction.IsNetTransaction = IsNetTransaction;
                        oelSaleTaxTransaction.SeqNo = 2;
                        oelSaleTaxTransaction.TrackNumber = 3;
                        oelSaleTaxTransaction.IdProject = Operations.IdProject;
                        oelSaleTaxTransaction.BookNo = Operations.BookNo;
                        oelSaleTaxTransaction.VoucherNo = Validation.GetSafeLong(InvEditBox.Text);
                        ...
                        oelSaleTaxTransaction.Date = VDate.Value;
                        oelSaleTaxTransaction.VoucherType = "S";
                        oelSaleTaxTransaction.TransactionType = 2;
                        oelSaleTaxTransaction.Description = "Tax Account Credited In Sale";
                        oelSaleTaxTransaction.Debit = 0;
                        oelSaleTaxTransaction.Credit = Validation.GetSafeDecimal(txtTotalSaleTaxAmount.Text); ;
                        oelSaleTaxTransaction.TransactionMode = "DR";
                        oelSaleTaxTransaction.CreatedDateTime = VDate.Value;
                        oelSaleTaxTransaction.Posted = chkPosted.Checked;
                        ...
                        if (chkPosted.Checked)
                        {
                            for (int j = 0; j < DgvSalesTransactions.Rows.Count - 1; j++)
                            {
                                ...
                                oelVoucherDetail.SeqNo = j + 4;
                                oelVoucherDetail.TrackNumber = j + 4;
        ...
        void frmfindProducts_ExecuteFindPorudctsEvent(object Sender, ItemsEL oelItems)
        {
            ...
            var manager = new ItemsBLL();
            List<ItemsEL> list = manager.GetItemById(oelItems.IdItem.Value);
            if (list.Count > 0)
            //if (manager.VerifyAccount(Operations.IdCompany, "Items", oelItems.AccountNo).Count > 0)
            {
                ...
                DgvStockSales.CurrentRow.Cells["colDims"].Value = list[0].Diemension;
                ...
                if (!IsRegisteredCustomer && list[0].ItemSaleTaxType == 3)
                {
                    DgvStockSales.CurrentRow.Cells["colSalesTaxPercentage"].Value = "17%";
                }
                if (IsRegisteredCustomer && list[0].ItemSaleTaxType == 3)
                {
                    DgvStockSales.CurrentRow.Cells["colSalesTaxPercentage"].Value = "17%";
                ...
                if (!IsRegisteredCustomer && list[0].ItemSaleTaxType == 3)
                {
                    DgvStockSales.CurrentRow.Cells["colExtraTaxPercentage"].Value = "3%";
                }
                else
                {
                    DgvStockSales.CurrentRow.Cells["colExtraTaxPercentage"].Value = "0%";
                }
            }
        }
            ...
            if (e.ColumnIndex == 34)
            {
                if (DgvStockSales.Rows[e.RowIndex].Cells["ColIdVoucherDetail"].Value == null)
                {
                    ...
                    for (int i = 0; i < DgvStockSales.Rows.Count - 1; i++)
                    {
                        ...
                        NormalDiscount += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountFlat"].Value);
                        BulkDiscount += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colBulkDiscountFlat"].Value);
                        ValueAfterDiscount += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colDiscountAmount"].Value);
                        TaxPayableFlat += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colSaleTaxFlat"].Value);
                        ExtraTaxPayableFlat += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colExtraTaxFlat"].Value);
                        NetAmount += Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNetAmount"].Value);
                    }
        ...
        private void DgvStockSales_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            decimal AssignQuantity = 0, ClosingStock = 0;
            decimal ConvertedQty = 0;
            decimal UnpostedQuantity = 0;
            string[] DimsArray = new string[3];
            string Diemension = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colDims"].Value);
            List<ItemsEL> arrItemTaxInfo = manager.GetItemById(Validation.GetSafeLong(DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value));
            if (Diemension != string.Empty)
            {
                DimsArray = Diemension.Split('*');
                if (Validation.GetSafeDecimal(DimsArray[1]) == 0)
                {
                    AssignQuantity = Validation.GetSafeDecimal(DimsArray[2]);
                }
                else
                {
                    AssignQuantity = Validation.GetSafeDecimal(DimsArray[1]);
                }
            }
            if (IdVoucher != null && IdVoucher > 0)
            {
                UnpostedQuantity = SManager.GetItemUnPostedSoldQuantity(IdVoucher.Value, Operations.IdProject, Operations.BookNo, Validation.GetSafeLong(DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value));
            }
            ClosingStock = manager.GetItemClosingStock(Validation.GetSafeLong(DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value));
            if (DgvStockSales.Columns[e.ColumnIndex].Name == "colQty")
            {
                if (Validation.GetSafeDecimal(DimsArray[1]) == 0)
                {
                    ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * AssignQuantity) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                }
                else
                {
                    ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * Validation.GetSafeDecimal(DimsArray[1]) * Validation.GetSafeDecimal(DimsArray[2])) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(DimsArray[2]) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
            0    }
                if (IdVoucher == null || IdVoucher == 0)
                {
                    if (ClosingStock < ConvertedQty)
                    {
                        MessageBox.Show("Less Cartons Stock Available For Sales");
                        DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value = "";
                        return;
                    }
                }
                else if ((ClosingStock + UnpostedQuantity) < ConvertedQty)
                {
                    MessageBox.Show("Less Cartons Stock Available For Sales");
                    DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value = "";
                    return;
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colUnitPrice"].Value == null)
                {
                    ...
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colUnitPrice"].Value = arrItemTaxInfo[0].MRP;
                    }
                }
                if (Validation.GetSafeLong(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) > 0)
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colUnitPrice"].Value) * ConvertedQty;
                }
                else
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colUnitPrice"].Value) * ConvertedQty;
                }
                if (DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value);
                    ...
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
                                                                                      * Validation.GetSafeDecimal(CellValue));
                        DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                    }
                    else
                    {
                ...
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value = 0 + "%";
                    DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = 0;
                    DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value);

                    if (DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value != null)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) - Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value);
                    }

                    if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value == null)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value = 0 + "%";
                        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value = 0;
                    }
                    if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value == null)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value = 0 + "%";
                        DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = 0;
                    }
                    if (DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value == null)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value = 0 + "%";
                        DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = 0;
                    }
                }
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                }
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value);
                    if (CellValue.Contains('%'))
                    {
                        CellValue = CellValue.Substring(0, CellValue.Length - 1);
                    }
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
                                                                                      * Validation.GetSafeDecimal(CellValue));
                        DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                    }
                    else
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value != null)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value);
                    if (CellValue.Contains('%'))
                    {
                        CellValue = CellValue.Substring(0, CellValue.Length - 1);
                    }
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        if (arrItemTaxInfo[0].ItemSaleTaxType == 1)
                        {
                            MessageBox.Show("This Is Exempt Item, No Taxation Is Required....");
                            DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value = "0%";
                            return;
                        }
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 2)
                        {
                            if (Validation.GetSafeDecimal(DimsArray[1]) == 0)
                            {
                                ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * AssignQuantity) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                            ...
                            DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = ConvertedQty * arrItemTaxInfo[0].ThirdScheduleTaxCalculationRatio; //((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                            DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value));
                        }
                        else
                        {
                           // DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value = CellValue + "%";
                            DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                            DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value));
                        }
                    }
                    else
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value != null)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value);
                    if (CellValue.Contains('%'))
                    {
                        CellValue = CellValue.Substring(0, CellValue.Length - 1);
                    }
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        ...
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 2)
                        {
                            ...
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = ConvertedQty * arrItemTaxInfo[0].ThirdScheduleTaxCalculationRatio; //((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                        }
                        else
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                    }
                }
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colBoxes")
            {
                if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) > 0)
                {
                    if (Validation.GetSafeDecimal(DimsArray[1]) == 0)
                    {
                        MessageBox.Show("This Product Does Not Contain Boxes...");
                        DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value = "";
                        return;
                    }
                }
                ...
                if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) > 0)
                {
                    if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) > 0)
                    {
                        ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * Validation.GetSafeDecimal(DimsArray[1]) * Validation.GetSafeDecimal(DimsArray[2])) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(DimsArray[2])) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                    }
                    else
                    {
                        ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(DimsArray[2])) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                    }
                }
                if (IdVoucher == null || IdVoucher == 0)
                {
                    if (ClosingStock < ConvertedQty)
                    {
                        MessageBox.Show("Less Boxes Stock Available For Sales");
                        DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value = "";
                        return;
                    }
                }
                ...
                {
                    //if (ClosingStock < ConvertedQty + UnpostedQuantity)
                    if ((ClosingStock + UnpostedQuantity) < ConvertedQty)
                    {
                        MessageBox.Show("Less Boxes Stock Available For Sales");
                        DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value = "";
                        return;
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value != null)
                {
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        ...
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 2)
                        {
                            ...
                            DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = ConvertedQty * arrItemTaxInfo[0].ThirdScheduleTaxCalculationRatio; //((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));                            
                            //DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                            DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value));
                        }
                        else
                        {
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value != null)
                {
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        ...
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 2)
                        {
                            ...
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = ConvertedQty * arrItemTaxInfo[0].ThirdScheduleTaxCalculationRatio; //((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                            //DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value));
                            //DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                        }
                        else
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                    }
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colPieces")
            {
                if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) > 0)
                {
                    if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) > 0)
                    {
                        if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) > 0)
                    ...
                    else
                    {
                        if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) > 0)
                        {
                            ...
                            {
                                ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * Validation.GetSafeDecimal(DimsArray[2])) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                            }
                        }
                        else
                        {
                            ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                        }
                    }
                }
                if (IdVoucher == null || IdVoucher == 0)
                {
                    if (ClosingStock < ConvertedQty)
                    {
                        MessageBox.Show("Less Pieces Stock Available For Sales");
                        DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value = "";
                        return;
                    }
                }
                else
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colBonusUnit")
            {
                if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) > 0)
                {
                    if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) > 0)
                    {
                        ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBoxes"].Value) * Validation.GetSafeDecimal(DimsArray[2])) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                    }
                    else
                    {
                        if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) > 0)
                ...
                if (IdVoucher == null || IdVoucher == 0)
                {
                    if (ClosingStock < ConvertedQty)
                    {
                        MessageBox.Show("Less Stock Available For Foc : ");
                        DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value = "";
                        return;
                    }
                }
                else
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colUnitPrice")
            {
                ...
                DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value = ConvertedQty *
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value != null)
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                }
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                ...
                {
                    DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value = 0 + "%";
                    DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value);
                }
                if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value != null)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value);
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colNormalDiscountPercentage")
            {
                if (DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value);
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value = CellValue + "%";
                        DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
                                                                                      * Validation.GetSafeDecimal(CellValue));
                        DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                    }
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value = CellValue + "%";
                        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
                                                              * Validation.GetSafeDecimal(CellValue));
                        DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
                    }
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colBulkDiscount")
            {
                DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountFlat"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscount"].Value));
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colBulkDiscountPercentage")
            {
                if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value != null)// && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value);
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value != null)
                {
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        ...
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 3)
                        {
                            DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value = ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value) / 100) * Validation.GetSafeDecimal(CellValue));
                        }
                    }
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colSalesTaxPercentage")
            {
                if (DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value != null)
                {
                    string CellValue = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colSalesTaxPercentage"].Value);
            ...
            else if (DgvStockSales.Columns[e.ColumnIndex].Name == "colExtraTaxPercentage")
            {
                ...
                if (DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value != null)
                {
                    ...
                    if (Validation.GetSafeDecimal(CellValue) > 0)
                    {
                        ...
                        {
                            MessageBox.Show("This Is Registered Customer, You Can Not Impose Extra Tax For Registered Customers");
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value = "0%";
                            return;
                        }
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 1)
                        {
                            MessageBox.Show("This Is Exempt Item, No Extra Taxation Is Required....");
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value = "0%";
                            return;
                        }
                        else if (arrItemTaxInfo[0].ItemSaleTaxType == 2)
                        {
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxPercentage"].Value = CellValue + "%";
                            if (Validation.GetSafeDecimal(DimsArray[1]) == 0)
                            {
                                ConvertedQty = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colQty"].Value) * AssignQuantity) + (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colPieces"].Value) + Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colBonusUnit"].Value));
                            }
                    ...
                    {
                        if (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colSaleTaxFlat"].Value) == 0)
                        {
                            DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colDiscountAmount"].Value);
                            DgvStockSales.Rows[e.RowIndex].Cells["colExtraTaxFlat"].Value = 0;
                        }
        ...
        {
            //decimal DiscTotalAmount = 0, AssignQuantity = 0, ConvertedQty = 0;
            //string[] DimsArray = new string[3];
            //string Diemension = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colDims"].Value);
            //if (Diemension != string.Empty)
            //{
            ...
            //    DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value = ConvertedQty * Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colUnitPrice"].Value);
            //    if (DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value != null)
            //    {
            //        if (DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value != null && Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value.ToString().Replace('%', ' ')) > 0)
            //        {
            ...
            //            if (Validation.GetSafeDecimal(CellValue) > 0)
            //            {
            //                DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) - ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
            //                                                                              * Validation.GetSafeDecimal(CellValue)));

            //            }
            //            else
            //            {
            //                DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value);
            ...
            //            if (Validation.GetSafeDecimal(CellValue) > 0)
            //            {
            //                DgvStockSales.Rows[e.RowIndex].Cells["colNetAmount"].Value = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) - ((Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value) / 100)
            //                                                                              * Validation.GetSafeDecimal(CellValue)));
            ...
            //        DiscTotalAmount += (Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colAmount"].Value) - Validation.GetSafeDecimal(DgvStockSales.Rows[i].Cells["colNormalDiscountFlat"].Value));
            //    }
            ...
            //    {
            //        //DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
            //        //                                                                   * Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"]);
            //        if (DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value.ToString().Contains('%'))
            //        {

            //        }
            //        else
            //            DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value) + "%";
            //    }
            //    else
            //    {
            //        DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"].Value = "0" + "%";
            ...
            //        //DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountFlat"].Value = (Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colAmount"].Value) / 100)
            //        //                                                                   * Validation.GetSafeDecimal(DgvStockSales.Rows[e.RowIndex].Cells["colNormalDiscountPercentage"]);
            //        if (DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value.ToString().Contains('%'))
            //        {

            //        }
            //        else
            //            DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value = Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value) + "%";
            //    }
            //    else
            //    {
            //        DgvStockSales.Rows[e.RowIndex].Cells["colBulkDiscountPercentage"].Value = "0" + "%";
        ...
        private void FillVoucher()
        {
            ...
            if (ListSales.Count > 0)
            {
                ...
                txtNormalDiscount.Text = Validation.GetSafeString(ListSales[0].NormalDiscount);
                txtBulkDiscount.Text = Validation.GetSafeString(ListSales[0].BulkDiscount);
                ...
                txtSaleTaxAmount.Text = Validation.GetSafeString(ListSales[0].SaleTaxAmount);
                txtOtherTaxAmount.Text = Validation.GetSafeString(ListSales[0].OtherTaxAmount);
                txtTotalSaleTaxAmount.Text = Validation.GetSafeString(ListSales[0].BillAmountIncludingTaxes);
        ...
        private void FillSales(List<VoucherDetailEL> List)
        {
            ...
            if (List != null && List.Count > 0)
            {
                ...
                for (int i = 0; i < List.Count; i++)
                {
                    ...
                    DgvStockSales.Rows[i].Cells[5].Value = List[i].Diemension;
                    ...
                    DgvStockSales.Rows[i].Cells[18].Value = CommonFunctions.RemoveTrailingZeros(List[i].Boxes);
                    DgvStockSales.Rows[i].Cells[19].Value = CommonFunctions.RemoveTrailingZeros(List[i].Pieces);
                    DgvStockSales.Rows[i].Cells[20].Value = CommonFunctions.RemoveTrailingZeros(List[i].Bonus);
                    DgvStockSales.Rows[i].Cells[21].Value = List[i].UnitPrice;
                    DgvStockSales.Rows[i].Cells[22].Value = List[i].Amount;
                    DgvStockSales.Rows[i].Cells[23].Value = List[i].Discount.ToString() + "%";
                    DgvStockSales.Rows[i].Cells[24].Value = List[i].DiscountAmount;
                    DgvStockSales.Rows[i].Cells[25].Value = List[i].BulkDiscountPercentage.ToString() + "%";
                    DgvStockSales.Rows[i].Cells[26].Value = List[i].BulkDiscountFlatAmount;
                    DgvStockSales.Rows[i].Cells[27].Value = List[i].FlatDiscount;
                    DgvStockSales.Rows[i].Cells[28].Value = List[i].BillAmountAfterDiscount;
                    DgvStockSales.Rows[i].Cells[29].Value = List[i].SaleTaxPercentage;
                    DgvStockSales.Rows[i].Cells[30].Value = List[i].SaleTaxFlatAmount;
                    DgvStockSales.Rows[i].Cells[31].Value = List[i].OtherTaxPercentage;
                    DgvStockSales.Rows[i].Cells[32].Value = List[i].OtherTaxFlatAmount;
                    DgvStockSales.Rows[i].Cells[33].Value = List[i].NetSaleAmount;
                }
            }
        }
        private void FillHeadTransactions(List<VoucherDetailEL> List)
        {
            for (int i = 0; i < List.Count; i++)
            {
                ...
                {
                    SalesTaxTransactionId = List[i].IdTransactionDetail;
                    cbxTaxPayables.SelectedValue = List[i].AccountNo;
                    SalesTaxAccountNo = List[i].AccountNo;
                }
            }
        }
        private void FillSalesTransactions(List<VoucherDetailEL> List)
        {
            ...
            if (List != null && List.Count > 0)
            {
                ...
                for (int i = 0; i < List.Count; i++)
                {
                    if (List[i].TrackNumber != 0 && List[i].TrackNumber != 1 && List[i].TrackNumber != 2 && List[i].TrackNumber != 3)
                    {

...
namespace Accounts.UI
{
    public partial class frmSalesReturn : MetroForm
    {
        ...
        private void FillData()
        {
            ...
            txtSheetNo.Text = manager.GetMaxPurchaseNumber(Operations.IdProject, Operations.BookNo, IsNetTransaction).ToString();
        }
                ...
                if (ValidateControls())
                {
                    if (ValidateBookPeriod())
                    {
                        ...
                        if (IsNetTransaction)
                        {
                            ...
                            {
                                oelCashTransaction.Description = "Cash Sale....";
                            }
                            else
                        ...
                        if (txtDescription.Text == string.Empty)
                        {
                            oelSaleTransaction.Description = "Sale Return From : " + SEditBox.Text;
                        }
                        else
                        {
                        ...
                        else
                        {
                            ...
                            if (infoResult.IsSuccess)
                            {
                                lblStatuMessage.Text = "Recorded Sales Return Updated Successfully...";
                                ClearControls();
                                //FillData();
                            }
                        }

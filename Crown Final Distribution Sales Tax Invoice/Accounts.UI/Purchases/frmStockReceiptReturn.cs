...
{
    public partial class frmStockReceiptReturn : MetroForm
    {
        #region Variables
        ...
        public frmStockReceiptReturn()
        {
            InitializeComponent();
        }
        private void frmStockReceiptReturn_Load(object sender, EventArgs e)
        {
        ...
        private void frmStockReceiptReturn_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (list.Count > 0)
            {
                ...
                if (objActiveType != null)
                {
                    ...
                    if (objActiveType.SoftwareType == "Distribution Trading")
                    {
                        ...
                        DgvStockReceipt.Columns["colItemName"].Width = 190;
                ...
                if (ValidateControls())
                {
                    if (ValidateBookPeriod())
                    {
                        ...
                        if (IsNetTransaction)
                        {
                            ...
                            {
                                oelCashTransaction.Description = "Cash Purchases Return From : " + SEditBox.Text;
                            }
                            else
                                oelCashTransaction.Description = txtDescription.Text;

                            oelCashTransaction.Debit = Convert.ToDecimal(txtTotalAmount.Text);
                        ...
                        oelPurchaseTransaction.Credit = Validation.GetSafeDecimal(txtAmountafterDiscount.Text);
                        ...
                        #region Add Tax Account In Transactions
                            ...
                            oelPurchaseTaxTransaction.VoucherType = "PR";
                            oelPurchaseTaxTransaction.TransactionType = 2;
                            oelPurchaseTaxTransaction.Description = "Tax Account Credit After Purchasing Return";
                            oelPurchaseTaxTransaction.Credit = Validation.GetSafeDecimal(txtTotalSaleTaxAmount.Text);
                        ...
                        if (IdVoucher == null || IdVoucher == 0)
                        {
                            ...
                            {
                                lblStatuMessage.Text = "Stock Returned Successfully...";
                                ClearControls();
                                FillData();
                            }
                        }
        ...
        //    List<ItemsEL> arrItemTaxInfo = manager.GetItemById(Validation.GetSafeLong(DgvStockReceipt.Rows[e.RowIndex].Cells["colIdItem"].Value));
        ...
        //            {
        //                DgvStockReceipt.Rows[e.RowIndex].Cells["colUnitPrice"].Value = arrItemTaxInfo[0].CurrentUnitPrice; //manager.GetItemById(Validation.GetSafeLong(DgvStockReceipt.Rows[e.RowIndex].Cells["colIdItem"].Value))[0].CurrentUnitPrice;
        //            }
        ...
        //                {
        //                    CellValue1 = CellValue.Substring(0, CellValue.Length - 1);
        //                }

...
namespace Accounts.BLL
{
    public class ItemsBLL
    {
        ...
        public List<VoucherDetailEL> GetItemsCurrentStockByCategory(Int64? IdCategory, Int64 IdProject)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
        ...
        public List<ItemsEL> GetProductFocLedger(Int64? IdItem)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetProductFocLedger(IdItem, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<ItemsEL> GetProductFocLedgerByDate(Int64? IdItem, DateTime dtStart, DateTime dtEnd)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetProductFocLedgerByDate(IdItem,dtStart, dtEnd, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<ItemsEL> GetProductFocLedgerByCustomer(Int64? IdItem, string AccountNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetProductFocLedgerByCustomer(IdItem, AccountNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();

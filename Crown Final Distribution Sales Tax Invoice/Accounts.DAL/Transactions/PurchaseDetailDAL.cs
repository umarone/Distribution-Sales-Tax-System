    ...
    public class PurchaseDetailDAL
    {
        ...
        public bool InsertPurchaseDetail(List<VoucherDetailEL> oelPurchaseCollection, Int64? Identity, SqlConnection objConn, SqlTransaction objTran)
        {
            ...
            for (int i = 0; i < oelPurchaseCollection.Count; i++)
            {
                ...
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@FinalQuantity", DbType.Decimal)).Value = oelPurchaseCollection[i].Qty;
                ...
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@BulkDiscountPercentage", DbType.Decimal)).Value = oelPurchaseCollection[i].BulkDiscountPercentage;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@BulkDiscountFlatAmount", DbType.Decimal)).Value = oelPurchaseCollection[i].BulkDiscountFlatAmount;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@AmountIncludingDiscounts", DbType.Decimal)).Value = oelPurchaseCollection[i].AmountIncludingDiscounts;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@SaleTaxPercentage", DbType.Decimal)).Value = oelPurchaseCollection[i].SaleTaxPercentage;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@SaleTaxFlatAmount", DbType.Decimal)).Value = oelPurchaseCollection[i].SaleTaxFlatAmount;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@OtherTaxPercentage", DbType.Decimal)).Value = oelPurchaseCollection[i].OtherTaxPercentage;
                cmdPurchaseDetail.Parameters.Add(new SqlParameter("@OtherTaxFlatAmount", DbType.Decimal)).Value = oelPurchaseCollection[i].OtherTaxFlatAmount;
        ...
        public List<PurchaseDetailEL> GetSupplierPurchase(string AccountNo, Int64 IdProject, SqlConnection objConn)
        {
            ...
            using (SqlCommand cmdSupplierPurchase = new SqlCommand("[Transactions].[Proc_GetSupplierPurchase]", objConn))
            {
                ...
                while (objReader.Read())
                {
                    ...
                    oelPurchaseDetail.Qty = Validation.GetSafeDecimal(objReader["TotalUnits"]);
        ...
        public List<PurchaseDetailEL> GetProductDetailPurchase(Int64 AccountNo, Int64 IdProject, SqlConnection objConn)
        {
            ...
            using (SqlCommand cmdProductPurchase = new SqlCommand("[Transactions].[Proc_GetProductDetailPurchase]", objConn))
            {
                ...
                while (objReader.Read())
                {
                    ...
                    oelPurchaseDetail.VDate = Validation.GetSafeDateTime(objReader["VDate"]);
                    oelPurchaseDetail.ItemName = Validation.GetSafeString(objReader["ItemName"]);
                    oelPurchaseDetail.Qty = Validation.GetSafeDecimal(objReader["Units"]);
                    oelPurchaseDetail.UnitPrice = Validation.GetSafeDecimal(objReader["UnitPrice"]);

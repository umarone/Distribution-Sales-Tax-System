                                                  ...
                                                  List<VoucherDetailEL> oelPurchaseTransactionsCollection, SqlConnection objConn)
       {
           lock (this)
           {
               ...
               try
               {
                   ...
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@SupplierAccountNo", DbType.String)).Value = oelVoucher.SubsidaryAccountNo;
                   ...
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@NormalDiscount", DbType.Decimal)).Value = oelVoucher.NormalDiscount;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@BulkDiscount", DbType.Decimal)).Value = oelVoucher.BulkDiscount;
                   ...
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@SaleTaxAmount", DbType.Decimal)).Value = oelVoucher.SaleTaxAmount;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@OtherTaxAmount", DbType.Decimal)).Value = oelVoucher.OtherTaxAmount;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@BillAmountIncludingTaxes", DbType.Decimal)).Value = oelVoucher.BillAmountIncludingTaxes;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@TotalFreight", DbType.Decimal)).Value = oelVoucher.TotalFreight;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@FinalAmount", DbType.Decimal)).Value = oelVoucher.TotalAmount;
       ...
       public List<VoucherDetailEL> GetPurchasesTransactions(Int64 IdVoucher, Int64 IdProject, Int64 BookNo, bool IsNetTransaction, SqlConnection objConn)
       {
           ...
           using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPurchasesTransactions]", objConn))
           {
               ...
               while (objReader.Read())
               {
                   ...
                   oelVoucher.SubsidaryAccountNo = Validation.GetSafeString(objReader["SupplierAccountNo"]);
                   ...
                   oelVoucher.NormalDiscount = Validation.GetSafeDecimal(objReader["NormalDiscount"]);
                   oelVoucher.BulkDiscount = Validation.GetSafeDecimal(objReader["BulkDiscount"]);
                   oelVoucher.BillAmountAfterDiscount = Validation.GetSafeDecimal(objReader["BillAmountAfterDiscount"]);
                   oelVoucher.SaleTaxAmount = Validation.GetSafeDecimal(objReader["SaleTaxAmount"]);
                   oelVoucher.OtherTaxAmount = Validation.GetSafeDecimal(objReader["OtherTaxAmount"]);
                   oelVoucher.BillAmountIncludingTaxes = Validation.GetSafeDecimal(objReader["BillAmountIncludingTaxes"]);
                   oelVoucher.TotalFreight = Convert.ToInt64(objReader["TotalFreight"]);
                   oelVoucher.TotalAmount = Convert.ToInt64(objReader["FinalAmount"]);
                   ...
                   oelVoucher.Diemension = Validation.GetSafeString(objReader["Diemension"]);
                   ...
                   oelVoucher.Qty = Validation.GetSafeDecimal(objReader["FinalQuantity"]);
                   ...
                   oelVoucher.BulkDiscountPercentage = Validation.GetSafeDecimal(objReader["BulkDiscountPercentage"]);
                   oelVoucher.BulkDiscountFlatAmount = Validation.GetSafeDecimal(objReader["BulkDiscountFlatAmount"]);
                   oelVoucher.AmountIncludingDiscounts = Validation.GetSafeDecimal(objReader["AmountIncludingDiscounts"]);
                   oelVoucher.SaleTaxPercentage = Validation.GetSafeDecimal(objReader["SaleTaxPercentage"]);
                   oelVoucher.SaleTaxFlatAmount = Validation.GetSafeDecimal(objReader["SaleTaxFlatAmount"]);
                   oelVoucher.OtherTaxPercentage = Validation.GetSafeDecimal(objReader["OtherTaxPercentage"]);
                   oelVoucher.OtherTaxFlatAmount = Validation.GetSafeDecimal(objReader["OtherTaxFlatAmount"]);
       ...
       public List<VoucherDetailEL> GetPOSPurchasesTransactions(Int64 IdVoucher, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
       {
           ...
           using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPOSPurchasesTransactions]", objConn))
           {
               ...
               while (objReader.Read())
               {
                   ...
                   oelVoucher.BillAmount = Convert.ToInt64(objReader["BillAmount"]);
                   oelVoucher.TotalFreight = Convert.ToInt64(objReader["TotalFreight"]);
                                                        ...
                                                        ,List<VoucherDetailEL> oelPurchaseTransactionsCollection, SqlConnection objConn)
       {
           lock (this)
           {
               ...
               try
               {
                   ...
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@TerminalNo", DbType.Int64)).Value = oelVoucher.TerminalNumber;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@BiltyNo", DbType.String)).Value = oelVoucher.BiltyNo;
                   //cmdPurchaseHead.Parameters.Add(new SqlParameter("@PersonName", DbType.String)).Value = oelVoucher.FirstName;
                   //cmdPurchaseHead.Parameters.Add(new SqlParameter("@PersonContact", DbType.String)).Value = oelVoucher.Contact;
                   //cmdPurchaseHead.Parameters.Add(new SqlParameter("@PersonCNIC", DbType.String)).Value = oelVoucher.Cnic;
                   //cmdPurchaseHead.Parameters.Add(new SqlParameter("@PersonAddress", DbType.String)).Value = oelVoucher.Address;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@VDate", DbType.DateTime)).Value = oelVoucher.VDate;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@AccountNo", DbType.String)).Value = oelVoucher.AccountNo;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@EmpCode", DbType.String)).Value = oelVoucher.SubAccountNo;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@BillNo", DbType.String)).Value = oelVoucher.BillNo;
                                                        ...
                                                        List<VoucherDetailEL> oelPurchaseTransactionsCollection, SqlConnection objConn)
       {
           lock (this)
           {
               ...
               try
               {
                   ...
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@TotalTaxAmount", DbType.Decimal)).Value = oelVoucher.TotalTaxAmount;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@IdStockAdjustmentType", DbType.Int64)).Value = oelVoucher.IdStockAdjustmentType;
                   cmdPurchaseHead.Parameters.Add(new SqlParameter("@IsNetPurchasesReturn", DbType.Boolean)).Value = oelVoucher.IsNetPurchasesReturn;

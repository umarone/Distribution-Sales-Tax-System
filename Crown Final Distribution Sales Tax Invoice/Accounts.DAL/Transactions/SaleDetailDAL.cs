    ...
    public class SaleDetailDAL
    {
        ...
        public bool InsertSaleDetail(List<VoucherDetailEL> oelSaleCollection, Int64? Identity, SqlConnection objConn, SqlTransaction oTran)
        {
            ...
            for (int i = 0; i < oelSaleCollection.Count; i++)
            {
                ...
                cmdSaleDetail.Parameters.Add(new SqlParameter("@Boxes", DbType.Decimal)).Value = oelSaleCollection[i].Boxes;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@Pieces", DbType.Decimal)).Value = oelSaleCollection[i].Pieces;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@FinalQuantity", DbType.Decimal)).Value = oelSaleCollection[i].Qty;
                ...
                cmdSaleDetail.Parameters.Add(new SqlParameter("@BulkDiscountPercentage", DbType.Decimal)).Value = oelSaleCollection[i].BulkDiscountPercentage;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@BulkDiscountFlatAmount", DbType.Decimal)).Value = oelSaleCollection[i].BulkDiscountFlatAmount;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@FlatDiscount", DbType.Decimal)).Value = oelSaleCollection[i].FlatDiscount;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@AmountIncludingDiscounts", DbType.Decimal)).Value = oelSaleCollection[i].AmountIncludingDiscounts;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@SaleTaxPercentage", DbType.Decimal)).Value = oelSaleCollection[i].SaleTaxPercentage;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@SaleTaxFlatAmount", DbType.Decimal)).Value = oelSaleCollection[i].SaleTaxFlatAmount;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@OtherTaxPercentage", DbType.Decimal)).Value = oelSaleCollection[i].OtherTaxPercentage;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@OtherTaxFlatAmount", DbType.Decimal)).Value = oelSaleCollection[i].OtherTaxFlatAmount;
                cmdSaleDetail.Parameters.Add(new SqlParameter("@NetSaleAmount", DbType.Decimal)).Value = oelSaleCollection[i].NetAmount;
        ...
        public bool InsertSalesReturnDetail(List<VoucherDetailEL> oelSalesReturnDetailCollection, Int64? Identity, SqlConnection objConn, SqlTransaction oTran)
        {
            ...
            for (int i = 0; i < oelSalesReturnDetailCollection.Count; i++)
            {
                ...
                cmdSalesReturn.Parameters.Add(new SqlParameter("@Boxes", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].Boxes;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@Pieces", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].Pieces;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@FinalQuantity", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].Qty;
                //cmdPurchaseDetail.Parameters.Add(new SqlParameter("@Bonus", DbType.Int64)).Value = oelPurchaseCollection[i].Bonus;
                ...
                cmdSalesReturn.Parameters.Add(new SqlParameter("@DiscPercentage", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].Discount;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@DiscountAmount", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].DiscountAmount;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@BulkDiscountPercentage", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].BulkDiscountPercentage;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@BulkDiscountFlatAmount", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].BulkDiscountFlatAmount;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@AmountIncludingDiscounts", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].AmountIncludingDiscounts;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@SaleTaxPercentage", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].SaleTaxPercentage;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@SaleTaxFlatAmount", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].SaleTaxFlatAmount;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@OtherTaxPercentage", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].OtherTaxPercentage;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@OtherTaxFlatAmount", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].OtherTaxFlatAmount;
                cmdSalesReturn.Parameters.Add(new SqlParameter("@NetSaleAmount", DbType.Decimal)).Value = oelSalesReturnDetailCollection[i].NetAmount;
        ...
        public List<SaleDetailEL> GetPartyWiseSaleSummaryForDistribution(Int64 IdProject, Int64 BookNo, string OrderBooker, string DeliveryMan, DateTime startDate, DateTime endDate, SqlConnection objConn)
        {
            List<SaleDetailEL> list = new List<SaleDetailEL>();

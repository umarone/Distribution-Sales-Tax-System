    ...
    public class ItemsDAL
    {
        ...
        public bool InsertItems(ItemsEL oelItems, SqlConnection objConn)
        {
            lock (this)
            {
                ...
                try
                {
                    ...
                    cmdItems.Parameters.Add(new SqlParameter("@CTN", DbType.String)).Value = oelItems.CTN;
                    cmdItems.Parameters.Add(new SqlParameter("@Boxes", DbType.Decimal)).Value = oelItems.Boxes;
                    cmdItems.Parameters.Add(new SqlParameter("@Pieces", DbType.Decimal)).Value = oelItems.Pieces;
                    cmdItems.Parameters.Add(new SqlParameter("@Diemension", DbType.String)).Value = oelItems.Diemension;
                    ...
                    cmdItems.Parameters.Add(new SqlParameter("@SaleTaxPercentage", DbType.Decimal)).Value = oelItems.SaleTaxPercentage;
                    cmdItems.Parameters.Add(new SqlParameter("@MRPInclusiveTax", DbType.Decimal)).Value = oelItems.MRPInclusiveTax;
                    cmdItems.Parameters.Add(new SqlParameter("@ThirdScheduleTaxCalculationRatio", DbType.Decimal)).Value = oelItems.ThirdScheduleTaxCalculationRatio;
                    ...
                    cmdItems.Parameters.Add(new SqlParameter("@ItemSaleTaxType", DbType.Int32)).Value = oelItems.ItemSaleTaxType;
                    cmdItems.Parameters.Add(new SqlParameter("@ItemType", DbType.Int32)).Value = oelItems.ItemType;
        ...
        public bool UpdateItems(ItemsEL oelItems, SqlConnection objConn)
        {
            ...
            try
            {
                ...
                //cmdItems.Parameters.Add(new SqlParameter("@BatchNo", DbType.String)).Value = oelItems.BatchNo;
                cmdItems.Parameters.Add(new SqlParameter("@BarCode", DbType.String)).Value = oelItems.BarCode;
                cmdItems.Parameters.Add(new SqlParameter("@CTN", DbType.Int32)).Value = oelItems.CTN;
                cmdItems.Parameters.Add(new SqlParameter("@Boxes", DbType.Decimal)).Value = oelItems.Boxes;
                cmdItems.Parameters.Add(new SqlParameter("@Pieces", DbType.Decimal)).Value = oelItems.Pieces;
                cmdItems.Parameters.Add(new SqlParameter("@Diemension", DbType.String)).Value = oelItems.Diemension;
                cmdItems.Parameters.Add(new SqlParameter("@CalculatedUnitPrice", DbType.Decimal)).Value = oelItems.CurrentUnitPrice;
        ...
        public bool InsertUpdateCurrentStock(List<VoucherDetailEL> list, SqlConnection objConn)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                cmdItems.Parameters.Add(new SqlParameter("@SecondIMEI", DbType.String)).Value = list[i].SecondIMEI;
                cmdItems.Parameters.Add(new SqlParameter("@ColorCode", DbType.Int32)).Value = list[i].ColorCode;
                cmdItems.Parameters.Add(new SqlParameter("@Units", DbType.Decimal)).Value = list[i].Units;
                cmdItems.Parameters.Add(new SqlParameter("@Boxes", DbType.Decimal)).Value = list[i].Boxes;
                cmdItems.Parameters.Add(new SqlParameter("@Pieces", DbType.Decimal)).Value = list[i].Pieces;
                cmdItems.Parameters.Add(new SqlParameter("@FinalQuantity", DbType.Decimal)).Value = list[i].Qty;
                cmdItems.Parameters.Add(new SqlParameter("@BonusUnits", DbType.Decimal)).Value = list[i].Bonus;
                cmdItems.Parameters.Add(new SqlParameter("@UnitPrice", DbType.Decimal)).Value = list[i].UnitPrice;
                cmdItems.Parameters.Add(new SqlParameter("@CurrentUnitPrice", DbType.Decimal)).Value = list[i].CurrentUnitPrice;
                cmdItems.Parameters.Add(new SqlParameter("@TotalAmount", DbType.Decimal)).Value = list[i].TotalAmount;
                cmdItems.Parameters.Add(new SqlParameter("@SaleTaxPercentage", DbType.Decimal)).Value = list[i].SaleTaxPercentage;
                cmdItems.Parameters.Add(new SqlParameter("@SaleTaxFlatAmount", DbType.Decimal)).Value = list[i].SaleTaxFlatAmount;
                cmdItems.Parameters.Add(new SqlParameter("@OtherTaxPercentage", DbType.Decimal)).Value = list[i].OtherTaxPercentage;
                cmdItems.Parameters.Add(new SqlParameter("@OtherTaxFlatAmount", DbType.Decimal)).Value = list[i].OtherTaxFlatAmount;
                cmdItems.Parameters.Add(new SqlParameter("@NetAmount", DbType.Decimal)).Value = list[i].NetAmount;
                cmdItems.ExecuteNonQuery();
                cmdItems.Parameters.Clear();
            }
        ...
        public List<ItemsEL> GetItemById(Int64 IdItem, SqlConnection objConn)
        {
            ...
            while (oReader.Read())
            {
                ...
                oelItems.MRP = Validation.GetSafeDecimal(oReader["MRP"]);
                oelItems.SaleTaxPercentage = Validation.GetSafeDecimal(oReader["SaleTaxPercentage"]);
                oelItems.MRPInclusiveTax = Validation.GetSafeDecimal(oReader["MRPInclusiveTax"]);
                oelItems.ThirdScheduleTaxCalculationRatio = Validation.GetSafeDecimal(oReader["ThirdScheduleTaxCalculationRatio"]);
                //oelItems.UnitPrice = Validation.GetSafeDecimal(oReader["UnitPrice"]);
                oelItems.BarCode = Validation.GetSafeString(oReader["BarCode"]);
                oelItems.CTN = Validation.GetSafeInteger(oReader["CTN"]);
                oelItems.Boxes = Validation.GetSafeDecimal(oReader["Boxes"]);
                oelItems.Pieces = Validation.GetSafeDecimal(oReader["Pieces"]);
                oelItems.Diemension = Validation.GetSafeString(oReader["Diemension"]);
                //oelItems.StockOnHand = Validation.GetSafeInteger(oReader["StockOnHand"]);
                oelItems.ItemSaleTaxType = Validation.GetSafeInteger(oReader["ItemSaleTaxType"]);
        ...
        public List<ItemsEL> GetItemsByCategory(Int64? IdCategory, SqlConnection objConn)
        {
            ...
            while (oReader.Read())
            {
                ...
                oelItems.ProductCode = Validation.GetSafeString(oReader["ItemCode"]);
                oelItems.ItemName = Validation.GetSafeString(oReader["ItemName"]);
                oelItems.ItemSaleTaxTypeName = Validation.GetSafeString(oReader["TaxableItemType"]);
                oelItems.MRP = Validation.GetSafeDecimal(oReader["MRP"]);
                oelItems.SaleTaxPercentage = Validation.GetSafeDecimal(oReader["SaleTaxPercentage"]);
                oelItems.MRPInclusiveTax = Validation.GetSafeDecimal(oReader["MRPInclusiveTax"]);
                oelItems.CategoryName = Validation.GetSafeString(oReader["Category_Name"]);
        ...
        public List<VoucherDetailEL> GetItemsCurrentStockByCategory(Int64? IdCategory, Int64 IdProject, SqlConnection objConn)
        {
            ...
            while (oReader.Read())
            {
                VoucherDetailEL oelItems = new VoucherDetailEL();
                oelItems.IdItem = Validation.GetSafeLong(oReader["Item_Id"]);
                ...
                oelItems.Units = Validation.GetSafeDecimal(oReader["Units"]);
                oelItems.Boxes = Validation.GetSafeDecimal(oReader["SBoxes"]);
                oelItems.Pieces = Validation.GetSafeDecimal(oReader["SPieces"]);
                oelItems.Qty = Validation.GetSafeDecimal(oReader["FinalQuantity"]);
                ...
                oelItems.SaleTaxPercentage = Validation.GetSafeDecimal(oReader["OSaleTaxPercentage"]);
                oelItems.SaleTaxFlatAmount = Validation.GetSafeDecimal(oReader["SaleTaxFlatAmount"]);
                oelItems.OtherTaxPercentage = Validation.GetSafeDecimal(oReader["OtherTaxPercentage"]);
                oelItems.OtherTaxFlatAmount = Validation.GetSafeDecimal(oReader["OtherTaxFlatAmount"]);


                oelItems.NetAmount = Validation.GetSafeDecimal(oReader["NetAmount"]);
                //oelItems.UnitPrice = Validation.GetSafeDecimal(oReader["UnitPrice"]);
                oelItems.BarCode = Validation.GetSafeString(oReader["BarCode"]);
                //oelItems.StockOnHand = Validation.GetSafeInteger(oReader["StockOnHand"]);
                //oelItems.ReorderLevel = Validation.GetSafeInteger(oReader["ReorderLevel"]);
        ...
        public List<ItemsEL> GetProductFocLedger(Int64? IdItem, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItem = new SqlCommand("[Reports].[Proc_GetFocLedger]", objConn);
            cmdItem.Parameters.Add(new SqlParameter("@IdItem", DbType.Int32)).Value = IdItem;
            cmdItem.CommandType = CommandType.StoredProcedure;
            objReader = cmdItem.ExecuteReader();
            while (objReader.Read())
            {
                ...
                oelItem.StockOnHandDate = Convert.ToDateTime(objReader["Date"]);
                oelItem.AccountName = Validation.GetSafeString(objReader["AccountName"]);
                oelItem.Qty = Validation.GetSafeDecimal(objReader["BonusUnits"]);
                oelItem.UnitPrice = Validation.GetSafeDecimal(objReader["Value"]);
        ...
        public List<ItemsEL> GetProductFocLedgerByDate(Int64? IdItem, DateTime dtStart, DateTime dtEnd, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItem = new SqlCommand("[Reports].[Proc_GetFocLedgerByDate]", objConn);
            cmdItem.Parameters.Add(new SqlParameter("@IdItem", DbType.Int32)).Value = IdItem;
            cmdItem.Parameters.Add(new SqlParameter("@StartDate", DbType.Int32)).Value = dtStart;
            cmdItem.Parameters.Add(new SqlParameter("@EndDate", DbType.Int32)).Value = dtEnd;
            cmdItem.CommandType = CommandType.StoredProcedure;
            objReader = cmdItem.ExecuteReader();
            while (objReader.Read())
            {
        ...
        public List<ItemsEL> GetProductFocLedgerByCustomer(Int64? IdItem, string AccountNo, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItem = new SqlCommand("[Reports].[Proc_GetFocLedgerByCustomer]", objConn);
            cmdItem.Parameters.Add(new SqlParameter("@IdItem", DbType.Int32)).Value = IdItem;
            cmdItem.Parameters.Add(new SqlParameter("@AccountNo", DbType.String)).Value = AccountNo;
            cmdItem.CommandType = CommandType.StoredProcedure;
            objReader = cmdItem.ExecuteReader();
            while (objReader.Read())
            {

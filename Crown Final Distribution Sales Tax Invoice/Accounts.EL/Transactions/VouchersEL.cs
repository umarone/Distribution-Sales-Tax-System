...
namespace Accounts.EL
{
    public class VouchersEL : StockAdjustmentsEL
    {
        ...
        public decimal BillAmountIncludingTaxes
        {
            get;
            set;
        }
        public decimal BulkDiscountPercentage
        {
            get;
            set;
        }
        public decimal BulkDiscountFlatAmount
        {
            get;
            set;
        }
        public decimal AmountIncludingDiscounts
        {
            get;
            set;
        }
        public decimal SaleTaxPercentage
        {
            get;
            set;
        }
        public decimal SaleTaxFlatAmount
        {
            get;
            set;
        }
        ...
        public decimal OtherTaxFlatAmount
        {
            get;
            set;
        }
